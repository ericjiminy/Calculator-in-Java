...
public class Calculator {
	...
	private JButton blank1, blank2, blank3, blank4, square, sqrt, delete, clear, zero, decimal, one, two, three, four, five, six, seven, eight, nine, divide, multiply, add, subtract, equals;
	...
	private int frameHeight = (int) screenSize.getHeight()*3/5;
	...
	private void createButtons() {
		buttonPanel.setLayout(new GridLayout(6,4, borderThickness/2, borderThickness/2));   // - buttonPanel has a 6 x 4 GridLayout. The cells have a border.
		...
		buttons.add(blank1);   // - Add all the buttons to ArrayList to use for-loops.
		buttons.add(blank2);
		buttons.add(blank3);
		buttons.add(blank4);
		buttons.add(square);
		...
		printableButtons.remove(blank1);
		printableButtons.remove(blank2);
		printableButtons.remove(blank3);
		printableButtons.remove(blank4);
